...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = DAC_SPI_SCK_Pin|DAC_SPI_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PB5     ------> SPI6_MOSI
    */
    GPIO_InitStruct.Pin = Shift_REG_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI6;
    HAL_GPIO_Init(Shift_REG_SCK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Shift_REG_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_SPI6;
    HAL_GPIO_Init(Shift_REG_MOSI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, FRAM_SCK_Pin|FRAM_MISO_Pin|FRAM_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, ADC_SPI_SCK_Pin|ADC_SPI_MISO_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, DAC_SPI_SCK_Pin|DAC_SPI_MISO_Pin);
  ...
  /* USER CODE END SPI6_MspDeInit 0 */
    ...
    PB5     ------> SPI6_MOSI
    */
    HAL_GPIO_DeInit(Shift_REG_SCK_GPIO_Port, Shift_REG_SCK_Pin);

    HAL_GPIO_DeInit(Shift_REG_MOSI_GPIO_Port, Shift_REG_MOSI_Pin);
